      ...
      <section className="limitations">
        ...
        <div>
          ...
          <p>
            ...
            않습니다. 수치 일치 검사는 사실 검증이 아닙니다. 텍스트 넘침은
            편집기의 실제 SVG 크기와 글꼴 폭 추정치로 확인합니다. PowerPoint의
            글꼴과 도형 표현은 뷰어에 따라 다를 수 있습니다.
          </p>
          <p>
            방문자별 데모 공간은 7일간 보관하며, 만료 데이터는 다음 신규 공간
            생성 시 정리됩니다. 자체 계정과 소유자, 작성자, 검수자, 열람자
            역할을 지원하지만 기업용 SSO와 이메일 계정 복구는 제공하지 않습니다.
            서버 메모리 저장 모드에서는 서버 재시작 시 데이터가 초기화되며 화면
            하단에 저장 모드를 표시합니다.
          </p>
        </div>
      </section>
