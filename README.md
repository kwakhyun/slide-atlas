...
| 로컬 검증      | Vitest **95개**, Playwright **45개** 통과, 타입 검사와 프로덕션 빌드 통과      |
...
| Vitest                                 | 로컬 **95개 통과**: 스키마, 검색, 품질, PPTX, DB 트랜잭션, 격리, 버전 사본, 덱 관리, AI 출력 검증                  |
| Playwright                             | 로컬 **45개 통과**; 이전 PostgreSQL CI **25개**, 2026-09-01 공개 배포 **24개 통과**: 핵심 흐름, PPTX, 충돌, 모바일 |
