...
승인된 템플릿 12개를 PPTX로 내보내 다시 가져오는 합성 왕복 평가에서 레이아웃과 전달 의도 12/12, 슬롯 텍스트 96.9%, 좌표 평균 오차 0을 확인했습니다. 같은 프로젝트가 만든 단순한 파일을 사용한 회귀 검사이며 외부 제작 PPTX 정확도로 일반화하지 않습니다. [평가 방법과 한계](docs/pptx-evaluation.md)를 함께 공개했습니다.
